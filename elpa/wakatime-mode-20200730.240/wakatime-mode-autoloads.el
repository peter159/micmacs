...
If called interactively, toggle `Wakatime mode'.  If the prefix
...
With prefix ARG, enable Global Wakatime mode if ARG is positive; otherwise, disable it.  If called
